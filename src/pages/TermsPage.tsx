  ...
  return (
    <div className="pt-28 pb-16 bg-theme-bg">
      <div className="container-main max-w-4xl">
        <AnimatedSection>
          <h1 className="text-3xl md:text-4xl font-bold text-theme-text-primary mb-4">Terms of Service</h1>
          <p className="text-theme-text-muted mb-10">Last updated: January 1, 2025</p>

          <div className="max-w-none">
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">1. Acceptance of Terms</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">2. Description of Service</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">3. Account Registration</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">4. Subscription and Payment</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">5. Acceptable Use</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">6. Data Ownership</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">7. Termination</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">8. Limitation of Liability</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">9. Changes to Terms</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">10. Contact</h2>
              <p className="text-theme-text-secondary leading-relaxed">
