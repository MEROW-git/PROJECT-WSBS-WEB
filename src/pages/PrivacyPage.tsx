  ...
  return (
    <div className="pt-28 pb-16 bg-theme-bg">
      <div className="container-main max-w-4xl">
        <AnimatedSection>
          <h1 className="text-3xl md:text-4xl font-bold text-theme-text-primary mb-4">Privacy Policy</h1>
          <p className="text-theme-text-muted mb-10">Last updated: January 1, 2025</p>

          <div className="max-w-none">
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">1. Information We Collect</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">2. How We Use Your Information</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">3. Data Storage and Security</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">4. Email Communications</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">5. Third-Party Services</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">6. Data Retention</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">7. Your Rights</h2>
              <p className="text-theme-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-theme-text-primary mb-3">8. Contact Us</h2>
              <p className="text-theme-text-secondary leading-relaxed">
